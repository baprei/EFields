...
Subj={'MNI_T1_1mm'};
Electrode_Montage='exp3_CP3_4_1';

% This is a simulation of the electrode Montage from Wöstmann et al., 2018
% Brain Stimulation


Current=[0.75e-3, -0.1875e-3, -0.1875e-3, -0.1875e-3, -0.1875e-3]; %2mA peak-to-peak



for SubjCnt=1:length(Subj)

    SimulationName=[Electrode_Montage,'_',num2str(Current(1)*1000),'_mA'];
...
ElectrodePositions={'CP3','C5','C1','P5','P1'}; %Frist electrode is the center
